<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title"><?php echo lang('addblog.header')?></h3>
    </div>
    <div class="panel-body">
        <?php echo form_open(base_url('admin/cms/blog/add'), array('class' => 'form-horizontal')); ?>
        ...
        <div class="form-group <?php if (form_error('description')) echo 'has-error'; ?>">
            ...
            <div class="col-md-9">
                <textarea class="form-control ckeditor" rows="5" name="description" id="editor"><?php echo set_value('description') ?></textarea>
