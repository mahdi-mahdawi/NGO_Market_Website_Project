<p><strong>Please find below, the summary of your order #{order_reference}</strong></p>
...
<table border="1">
    <tr>
        <td width="20%">Pre-order</td>
        <td width="80%">{preorder_text}</td>
    </tr>
    <tr>
        <td width="20%">Date</td>
        <td width="80%">{preorder_date}</td>
    </tr>
    <tr>
        <td width="20%">Time</td>
        <td width="80%">{preorder_time}</td>
    </tr>
    <tr>
</table>
